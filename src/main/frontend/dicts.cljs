...
## Hi, welcome to Stepseq!
:PROPERTIES:
:heading: true
:END:
## Stepseq is a _privacy-first_, _open-source_ platform for _knowledge_ sharing and management.
...
:END:
"
        :on-boarding/title "Hi, welcome to Stepseq!"
        ...
        :publishing/delete-from-stepseq "Delete From Stepseq Server"
        ...
        :draw/back-to-stepseq "Back to stepseq"
        :text/image "Image"
...
## Привет, добро пожаловать в StepSeq!
:PROPERTIES:
:heading: true
:END:
## Stepseq это платформа с открытым кодом для исследований, в том числе отмечать шаги по достижению жизненных целей.
## This is a 3 minute tutorial on how to use Logseq. Let's get started!
## (Feel free to edit anything, no change will be saved at this moment. If you do want to persist your work, click the **top-right** corner of the screen to connect Logseq to either Github or local directory.)
## Here are some tips might be useful.
#+BEGIN_TIP
...
"
        ...
        :export-markdown "Экспортировать как Markdown"
        ...
        :parsing-files "Parsing files"
        :loading-files "Loading files"
        :login-github "Войти с помощью Github"
        :login-google "Войти с помощью Google"
        :login "Войти"
        :go-to "Перейти "
        :or "или"
        :download "Скачать"
        :repo/download-zip "Скачать все файлы как zip архив"
        :language "Язык"
        :white "Светлая"
        :dark "Темная"
        ...
        :user/delete-account "Удалить учетную запись"
        :user/delete-your-account "Удалить вашу учетную запись"
        :user/delete-account-notice "Все страницы которые вы опубликовали на stepseq.com будут удалены."}
   ...
   :de {:help/about "Über Logseq"
        ...
        :publishing/delete-from-stepseq "Vom Stepseq Server löschen"
        ...
        :draw/back-to-stepseq "Zurück zu Stepseq"
        :text/image "Bild"
   ...
   :fr {:help/about "A propos de Logseq"
        ...
        :draw/back-to-stepseq "Retourner sur stepseq"
        :content/copy "Copier"
        :content/cut "Couper"
   ...
   :zh-CN {:on-boarding/title "你好，欢迎使用 Logseq！"
           ...
           :publishing/delete-from-stepseq "从Stepseq服务器删除"
           :publishing/edit "修改"
           :publishing/save "保存"
           ...
           :draw/back-to-stepseq "返回 stepseq"
           :content/copy "复制"
           :content/cut "剪切"
   ...
   :zh-Hant {:on-boarding/title "你好，歡迎使用 Logseq！"
             ...
             :publishing/delete-from-stepseq "從Stepseq服務器刪除"
             :publishing/edit "修改"
             :publishing/save "保存"
             :publishing/cancel "取消"
             :publishing/delete "删除"
   ...
   :af {:on-boarding/title "Hi, welcome to Logseq!"
        ...
        :draw/back-to-stepseq "Terug na stepseq"
